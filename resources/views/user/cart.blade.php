    ...
    @endif
        ...
        @if ($cartTotalQuantity == 0)
            <div class="flex flex-col h-screen my-auto items-center justify-center text-5xl space-y-2">
                <p class="text-7xl text-gray-500 font-semibold text-center mt-10"> No Item Here</p>
                <a href="/" title=""
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <a href="#" class="shrink-0 md:order-1">
                                                <img class="h-20 w-20 dark:hidden" src="{{ asset('storage/' . $item->attributes->image) }}"
                                                    alt="imac image" />
                                                <img class="hidden h-20 w-20 dark:block" src="{{ asset('storage/' . $item->attributes->image) }}"
                                                    alt="imac image" />
                                            </a>
                                            {{-- quantity --}}
                                            ...
                                            <div class="flex items-center justify-between md:order-3 md:justify-end">
                                                <div class="flex items-center">
                                                    ...
                                                    <input readonly type="text" id="counter-input" data-input-counter
                                                        class="w-10 shrink-0 border-0 bg-transparent text-center text-sm font-medium text-gray-900 focus:outline-none focus:ring-0 dark:text-white"
                                                        placeholder="" value="{{ $item->quantity }}" required />
                                                    <a href="{{ route('increase.quantity', $item->id) }}">
                                                ...
                                                <div class="flex-col-reverse">
                                                    <div class="text-end md:order-4 md:w-32"> Total</div>
                                                    <div class="text-end md:order-4 md:w-32">
                                                        <p class="text-base font-bold text-gray-900 dark:text-white">
                                                            @money(number_format($item->price * $item->quantity, 2), 'usd')</p>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                                                <div class="">
                                                    ...
                                                    <p>
                                                        ...
                                                        <span class="">{{ $item->attributes->company }}</span>
                                                    </p>
                                                    <p
                                                ...
                                                <div class="flex items-center gap-4">
                                                    {{-- remove item --}}
                                                    <a href="{{ route('remove.cart', $item->id) }}"> <button type="button"
                            ...
                            <div
                                ...
                                <div class="space-y-4">
                                    ...
                                    <dl
                                        ...
                                        <dd class="text-base font-bold text-gray-900 dark:text-white">@money($total, 'usd')
                                        </dd>
                                    </dl>
                                </div>
