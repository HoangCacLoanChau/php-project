...
@section('content')
    @auth
        ...
        <section class=" antialiased dark:bg-gray-900 ">
            <div class="w-full max-w-screen-xl  2xl:px-0">
                            ...
                            <table
                                ...
                                <thead>
                                    <tr class="text-left border-b dark:border-gray-700">
                                        ...
                                        <th class="py-3 px-6 text-sm font-medium text-gray-900 dark:text-white">Company</th>
                                        <th class="py-3 px-6 text-sm font-medium text-gray-900 dark:text-white">Price</th>
                                        <th class="py-3 px-6 text-sm font-medium text-gray-900 dark:text-white">Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
