            ...
            <div class="flex justify-between items-center mb-6">
                ...
                <div class="flex">
                    ...
                    <form action="/logout" method="POST">
                        @csrf
                        <button
                            class=" focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5  mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Log
                            out</button>
                    </form>
                </div>
            </div>
